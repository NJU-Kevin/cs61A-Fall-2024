...
def boar_brawl(player_score, opponent_score):
    """Return the points scored when the current player rolls 0 dice according
    to Boar Brawl.
    ...
    """
    # BEGIN PROBLEM 2
    player_points = player_score % 10
    opponent_points = (opponent_score // 10) % 10
    return max(3 * abs(player_points - opponent_points), 1)
    # END PROBLEM 2
...
def play(strategy0, strategy1, update, score0 = 0, score1 = 0, dice=six_sided,
         goal = GOAL):
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    if sus_update(0, score, opponent_score) > sus_update(6,
...
def run(*args):
    ...
    parser.add_argument(
        "--run_experiments", "-r", action="store_true",
