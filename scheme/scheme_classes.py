...
class Frame:
    ...
    def define(self, symbol, value):
        ...
        # BEGIN PROBLEM 1
        """Define a Scheme symbol SYMBOL to have VALUE in this frame."""
    ...
    def lookup(self, symbol):
        ...
        # BEGIN PROBLEM 1
        """Return the value bound to Scheme symbol SYMBOL in this frame or parent frames."""
        if not isinstance(symbol, str):
            raise SchemeError('lookup: symbol must be a string, not {0}'.format(type(symbol).__name__))
    ...
    def make_child_frame(self, formals, vals):
        ...
        formal_copy = formals
        val_copy = vals
        while formal_copy is not nil:
            child_frame.define(formal_copy.first, val_copy.first)
            formal_copy = formal_copy.rest
            val_copy = val_copy.rest
        return child_frame
        # END PROBLEM 8
