...
class VendingMachine:
    ...
    def __init__(self, product, price):
        ...
        self.price = price # price per product
        self.stock = 0 # number of product in this machine
    ...
    def vend(self):
        ...
        if self.stock == 0:
            ...
            self.stock -= 1
            if change > 0:
                return (f'Here is your {self.product} and '
                        f'${change} change.')
            else:
...
def two_list(vals, counts):
    ...
    while index >= 0:
        if index == len_vals - 1:
            for i in range(1, counts[index]):
                result = Link(vals[index], result)
        else:
            for i in range(1, counts[index] + 1):
                result = Link(vals[index], result)
        index -= 1
    return result
