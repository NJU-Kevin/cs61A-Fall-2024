...
# installed.
TCL_PREFIX='D:/cs61A/env/cs61A\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/cs61A/env/cs61A\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/cs61A/env/cs61A\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/cs61A/env/cs61A\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/cs61A/env/cs61A\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/cs61A/env/cs61A\Library\lib\tclstub86.lib'
